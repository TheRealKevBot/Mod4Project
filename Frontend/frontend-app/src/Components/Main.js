    ...
    render() {
        return (
            <main className="main">
                ...
                {/* HOME */}<Route exact path='/' animal={this.state.animals} render={(routerProps) => <Home {...routerProps} animals={this.state.animals} user={this.state.user}/>} />
                ...
                {/* ACCOUNT */} <Route path='/account' render={(routerProps) => <Account {...routerProps} error={this.state.error} signUp={this.signUp} signIn={this.signIn} user={this.state.user} />} /> 

...
export default function Home(props) {
    return (
        <div>
            ...
            <p>We understand that people most often look for a certain breed or for kittens/puppies, but we highly recommend
            ...
            <p>It is our mission to help find a home for all animal's in need, and we hope that you will join us!</p>
            <PetsContainer />
        </div>
    )
}
